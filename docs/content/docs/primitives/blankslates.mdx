...
- **Simple Placeholder**: Displays three dashes as a visual placeholder
- **Monospace Font**: Uses monospace uppercase font for consistency
- **Muted Styling**: Uses muted color to indicate empty state
- **Customizable**: Supports custom styling via className

## Styling

The component uses:
- `mono-upper` - Monospace uppercase font
- `text-subtle/60` - Muted text color with 60% opacity
