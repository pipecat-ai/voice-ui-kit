...
- **Drag to Resize**: Users can drag handles to resize panels
- **Horizontal & Vertical**: Supports both layout directions
- **Multiple Panels**: Can create layouts with any number of panels
- **Visible Handles**: Optional visible handle icons for better UX
- **Customizable**: Supports custom styling and handle icons
- **Accessible**: Proper cursor styles and focus management
