...
Include both microphones and speakers in the device dropdown for comprehensive audio device management.
...
You can hide specific device types from the dropdown. For example, show only speakers:

<LiveComponent language="tsx" withPipecat>
{`
  import { UserAudioControl } from "@pipecat-ai/voice-ui-kit";

  <UserAudioControl noMicrophones />
`}
</LiveComponent>

Or show only microphones:

<LiveComponent language="tsx" withPipecat>
{`
  import { UserAudioControl } from "@pipecat-ai/voice-ui-kit";

  <UserAudioControl noSpeakers />
`}
</LiveComponent>

#### Custom Dropdown Label

Customize or hide the main dropdown label.

<LiveComponent language="tsx" withPipecat>
{`
  import { UserAudioControl } from "@pipecat-ai/voice-ui-kit";

  <UserAudioControl dropdownMenuLabel="Select Audio Device" />
`}
</LiveComponent>

Hide the main label entirely:

<LiveComponent language="tsx" withPipecat>
{`
  import { UserAudioControl } from "@pipecat-ai/voice-ui-kit";

  <UserAudioControl dropdownMenuLabel={null} />
`}
</LiveComponent>

#### Custom Device Labels

Customize the labels for device sections in the dropdown.
...
{`
  ...
  <UserAudioControl 
    microphoneLabel="Input Devices"
    speakerLabel="Output Devices"
  />
`}
</LiveComponent>
...
- **Speaker Selection**: Optional speaker device selection in the same dropdown
- **Flexible Device Display**: Exclude specific device types or customize section labels
