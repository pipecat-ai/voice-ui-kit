...
- **Multiple Parts**: Handles messages with multiple text parts
- **Smart Spacing**: Adds spaces between consecutive text parts
- **Thinking Indicator**: Automatically shows thinking indicator for empty messages
- **Timestamp**: Displays formatted timestamp at the bottom
- **Customizable**: Supports custom styling for content, thinking indicator, and timestamp
