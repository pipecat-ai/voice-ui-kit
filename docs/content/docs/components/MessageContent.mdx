...
<TypeTable
  ...
  type={{
    ...
    aggregationMetadata: {
      description: "Metadata for custom aggregation types. Controls whether a type should render inline vs block and whether it is expected to be spoken (karaoke-style highlighting).",
