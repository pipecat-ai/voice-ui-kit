...
changelog:
  - version: "v0.14.0"
    date: "2026-09-09"
    changes:
      - "Added `livekit` as a valid `transportType` value."
      - "Added `LiveKitTransportConstructorOptions` as a valid `transportOptions` type."
  - version: "v0.13.0"
    date: "2026-07-20"
    changes:
      - "Added `moq` as a valid `transportType` value."
      - "Added `MoqTransportOptions` as a valid `transportOptions` type."
  - version: "v0.11.0"
    date: "2026-05-11"
    changes:
