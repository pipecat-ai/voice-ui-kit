...
Function call display requires [`@pipecat-ai/client-js`](https://github.com/pipecat-ai/pipecat-client-web) >= 1.6.0 and corresponding transport versions ([`@pipecat-ai/daily-transport`](https://github.com/pipecat-ai/pipecat-client-web-transports) >= 1.6.0 or [`@pipecat-ai/small-webrtc-transport`](https://github.com/pipecat-ai/pipecat-client-web-transports) >= 1.9.0).
...
- `PipecatClientProvider` context (for transport state and conversation state)
