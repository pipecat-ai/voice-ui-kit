...
- **Role Display**: Shows the message role (user, assistant, system) with customizable labels
- **Content Rendering**: Renders message content parts with proper spacing
- **Thinking Indicator**: Automatically shows thinking indicator for empty messages
- **Timestamp**: Displays message creation timestamp
- **Customizable**: Supports custom styling for all parts
- **Flexible**: Works with single or multiple message parts
