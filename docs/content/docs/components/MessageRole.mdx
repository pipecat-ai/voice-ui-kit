...
- **Color-coded**: Different colors for user, assistant, and system roles
- **Customizable Labels**: Supports custom labels for each role type
- **Monospace Font**: Uses monospace font for consistent appearance
- **Semantic Styling**: Color classes match theme tokens (text-client, text-agent, text-subtle)
