## Contributing to Voice UI Kit

We welcome contributions of all kinds! Your help is appreciated. Follow these steps to get involved:

1. **Fork this repository**: Start by forking the Voice UI Kit repository to your GitHub account.

2. **Clone the repository**: Clone your forked repository to your local machine.
   ```bash
   git clone https://github.com/your-username/voice-ui-kit
   ```
...
6. **Commit your changes**: This project uses [Conventional Commits](https://www.conventionalcommits.org/). At least one commit per PR must follow the format:
   ...
   Common types: `feat`, `fix`, `docs`, `chore`, `refactor`, `perf`, `test`, `ci`, `build`
